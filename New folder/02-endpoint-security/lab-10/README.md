## Lab 10 – Endpoint: Process Tree and Parent-Child Analysis

### Scenario
EDR has flagged a suspicious process spawned from a legitimate application. Your task is to **trace the process tree**: identify the parent process, any child processes, and whether the chain suggests living-off-the-land techniques (e.g. scripting, LOLBins) or a dropped payload. Document the execution path for the incident report.
